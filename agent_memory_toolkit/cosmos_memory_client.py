...
class CosmosMemoryClient(_BaseMemoryClient):
    ...
    def _init_services(self) -> None:
        self._store = MemoryStore(self._container_client, embeddings_client=self._embeddings_client)
        self._pipeline = PipelineService(self._store, self._chat_client, self._embeddings_client)
    ...
    def _get_pipeline(self) -> PipelineService:
        ...
        if self._pipeline is None:
            self._pipeline = PipelineService(self._get_store(), self._chat_client, self._embeddings_client)
    ...
    def get_thread(
        ...
        return self._get_store().get_thread(thread_id, user_id, memory_types, recent_k, tags, exclude_tags, include_superseded)
