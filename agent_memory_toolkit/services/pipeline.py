...
live in :mod:`agent_memory_toolkit.services._pipeline_helpers` and are shared
with :class:`agent_memory_toolkit.aio.services.pipeline.AsyncPipelineService`.
"""
    ...
    def synthesize_procedural(
        ...
        *,
        ...
        if not new_doc["source_fact_ids"]:
            # ProceduralRecord requires a non-empty source set; fall back to
            # the source_episodic_ids list to satisfy the invariant when the
            # synthesis was driven entirely off episodic lessons.
