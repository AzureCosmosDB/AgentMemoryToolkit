...
* :class:`azure.cosmos.agent_memory.processors.inprocess.InProcessProcessor`
* :class:`azure.cosmos.agent_memory.processors.durable.DurableFunctionProcessor`
"""
...
class MemoryProcessor(Protocol):
    ...
    mirror lives at :mod:`azure.cosmos.agent_memory.aio.processors`.
